...
complete_species = [species[S]
                    for S in ("POSF10264", "O2", "N2", "CO2", "H2O")]
...
for i in range(len(phi)):
    ...
    gas1.set_equivalence_ratio(phi[i], "POSF10264", "O2:1, N2:3.76")
    gas1.equilibrate("HP")
    T_complete[i] = gas1.T
...
for i in range(len(phi)):
    ...
    gas2.set_equivalence_ratio(phi[i], "POSF10264", "O2:1, N2:3.76")
    gas2.equilibrate("HP")
